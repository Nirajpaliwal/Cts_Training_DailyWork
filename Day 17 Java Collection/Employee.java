// store user define object into collection
...
//	}
	...
	// to sort on the basis of id in ascending order
//	@Override
...
//	}
	...
	// to sort on the basis of id in descending order
//		@Override
//		public int compareTo(Employee emp) {
//			if (this.id > emp.id) {
//				return -1;
...
//		}
	...
	// to sort on the basis of age in ascending order
//	@Override
//	public int compareTo(Employee emp) {
//		if (this.age > emp.age) {
//			return 1;
